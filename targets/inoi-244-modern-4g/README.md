...
private USB session, headphone PCM playback, ARMADA, TyrQuake, MicroPythonOS
...
Physical LCD brightness and keypad-light effects have not been tested. The
...
untested. Telemetry has been read with the battery absent; that does not
demonstrate battery measurements or charging. Battery-only power-off and
physical-key wake have not been tested.
...
| ------------------------------------------------------- | --------- | ---------------------------------------------------------------------------------------------------------------- |
| [FPLinux: ARMADA](../../docs/apps/SHOWCASE.md)          | Supported | Runs in both profiles; physical light effects have not been tested, and there is no vibration without a battery. |
