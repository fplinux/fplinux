...
headphone PCM playback, ARMADA, TyrQuake and the shared graphics applications.
MicroPythonOS launches, but its UI is not fully adapted to this phone's screen.
microSD ext4 storage and a writable microSD system root work. Bluetooth pairing,
bidirectional file transfer and PAN Internet work in both profiles. RTC alarms
wake the phone from s2idle, including with mounted ext4 storage and card-backed
swap; applications, Bluetooth and graphics work again after wake.

Physical display, key and brightness effects have not been tested on this
...
vibration with a battery has not been tested. Telemetry read without a battery
does not demonstrate battery operation, measurement accuracy or charging.
...
| [Keypad backlight](../../docs/features/KEYPAD_BACKLIGHT.md)       | Unknown  | Partial       | LED control is available; its physical effect has not been tested.                                                                                 |
...
| [Vibration](../../docs/features/VIBRATION.md)                     | Present  | Partial       | Force-feedback interface responds; no physical vibration under Linux without a battery. Battery-powered operation has not been tested.             |
...
| ------------------------------------------------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [FPLinux: ARMADA](../../docs/apps/SHOWCASE.md)          | Supported | Runs in both profiles; physical display and light effects have not been tested, and there is no vibration without a battery. |
...
using a NAND backup from this exact phone. One acquisition prepares the
Bluetooth group and the independent fitted headphone gain profile. See the
