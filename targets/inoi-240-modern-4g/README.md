...
This experimental target runs Linux in volatile RAM with a local `128×160`
...
Use the shared [application guide](../../docs/APPLICATIONS.md). Its `128×160` UI
remains partial: launcher content and some application controls are clipped.
This target has no supported microSD path, so application state remains in RAM.
