...
| [Real-time clock](../../docs/features/RTC.md)                      | Present  | Partial       | Read/set time, one-shot alarms and RTC wake in both profiles, including after time correction; no update interrupts or alarm power-on.            |
