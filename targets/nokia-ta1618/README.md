...
| [Speaker audio](../../docs/features/SPEAKER_AUDIO.md)              | Present  | Partial       | One speaker above the display; selectable 48-kHz PCM output with fitted gains at all nine levels.                                                 |
