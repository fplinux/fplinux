...
| [Speaker audio](../../docs/features/SPEAKER_AUDIO.md)              | Present  | Partial       | One speaker above the display; selectable 48-kHz PCM output with fitted gains. Higher acoustic levels have not been measured.                     |
| [Phone microphone](../../docs/features/MICROPHONE_AUDIO.md)        | Present  | Supported     | Built-in and original wired-headset microphones; 48-kHz mono capture can run alongside 48-kHz stereo headphones.                                  |
| [FM radio](../../docs/features/FM_RADIO.md)                        | Present  | Supported     | Frequency scan and headphone playback through the 3.5 mm cable; candidates need listening to confirm.                                             |
...
settings and the fitted headphone and speaker gain profile.
