...
PACKAGE_DOCUMENTS = {
    ...
    "docs/features/AUXADC.md": ROOT / "docs/features/AUXADC.md",
    "docs/features/BATTERY_TELEMETRY.md": ROOT / "docs/features/BATTERY_TELEMETRY.md",
    "docs/features/BLUETOOTH.md": ROOT / "docs/features/BLUETOOTH.md",
    "docs/features/CHARGER_STATUS.md": ROOT / "docs/features/CHARGER_STATUS.md",
    ...
    "docs/features/SOC_TEMPERATURE.md": ROOT / "docs/features/SOC_TEMPERATURE.md",
