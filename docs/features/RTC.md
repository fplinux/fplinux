...
qualified time, alarm and wake behavior; a standalone archive describes that
...
and profiles with qualified RTC wake, an armed alarm can wake the system from
