...
#define UMS9117_TIMER_SYSCNT_CURRENT 0x0c
#define UMS9117_TIMER_SYSCNT_HZ 1000

static void __iomem *ums9117_syscnt_base;

static u64 notrace ums9117_sched_clock_read(void)
{
	return readl_relaxed(ums9117_syscnt_base +
			     UMS9117_TIMER_SYSCNT_CURRENT);
}
...
static int __init ums9117_syscnt_init(struct device_node *node)
{
	...
	ret = clocksource_mmio_init(base + UMS9117_TIMER_SYSCNT_CURRENT,
				    "ums9117_syscnt", UMS9117_TIMER_SYSCNT_HZ,
