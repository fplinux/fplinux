...
static int ums9117_musb_cold_start(struct musb *musb)
{
	...
	/*
	 * The stock firmware's normal cold path selects bit 27, while its
	 * test-mode path proves direct read-modify-write access to this base
	 * register. Bit 28 belongs to that separate electrical test mode and is
	 * preserved.
	 */
